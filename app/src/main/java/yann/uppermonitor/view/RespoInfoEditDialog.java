...
public class RespoInfoEditDialog extends Dialog implements View.OnClickListener {

    private Context mContext;

    public RespoInfoEditDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_layout_respo_edit);
